...
#+begin_src emacs-lisp
  ...
  (add-hook 'server-after-make-frame-hook
          (lambda ()
            (when (fboundp 'dashboard-setup-startup-indicator)
...
#+begin_src emacs-lisp
  ...
  (use-package company
    ...
    (setopt company-frontends '(company-pseudo-tooltip-frontend
                                company-preview-frontend
                                company-echo-metadata-frontend))
    (setopt company-backends '((company-capf company-yasnippet company-files)))
    :config
  ...
  (use-package lsp-mode
    ...
    (setopt lsp-headerline-breadcrumb-segments '(file symbols))
    :hook
    (prog-mode . lsp)
    :commands lsp)
  ...
  (use-package helm-lsp
    :after lsp-mode
    :init
    (message "Loaded helm-lsp")
    :commands helm-lsp-workspace-symbol)

  (use-package lsp-treemacs
    :after lsp-mode
    :init
    (message "Loaded lsp-treemacs")
...
#+begin_src emacs-lisp
  ...
  (setopt indent-line-function 'insert-tab)
